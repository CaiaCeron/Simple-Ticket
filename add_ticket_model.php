		...
		<form method="post" id="ticketForm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group" <label for="subject" class="control-label">Título</label>
					...
					<div class="form-group">
						<label for="message" class="control-label">Menssagem</label>
						<textarea class="form-control" rows="5" id="message" name="message"></textarea>
					</div>
					<div class="form-group">
						<label for="status" class="control-label">Situação</label>
						<label class="radio-inline">
							<input type="radio" name="status" id="open" value="0" checked required>Abrir
						</label>
						<?php if (isset($_SESSION["admin"])) { ?>
							<label class="radio-inline">
								<input type="radio" name="status" id="close" value="1" required>Fechar
							</label>
						<?php } ?>
					</div>
				</div>
